...
const Login = ({ auth, setAuth }) => {
  ...
  return (
    <Container
      maxWidth
      component="main"
      sx={{ bgcolor: "#212529", color: "#F8F9FA" }}
    >
      <CssBaseline />
      <Box
        component="form"
      ...
      >
        <Typography sx={{ fontSize: 30, mt: 15, color: '#FF577F' }} component="p" variant="h1">
          Kenzie Hub
        </Typography>
        ...
        <Box height="100vh">
          ...
          <Button
            component={Link}
            to="/register"
            style={{ marginTop: "30px", backgroundColor: "#868E96" }}
            variant="contained"
            fullWidth
          >
            Cadastrar-se
